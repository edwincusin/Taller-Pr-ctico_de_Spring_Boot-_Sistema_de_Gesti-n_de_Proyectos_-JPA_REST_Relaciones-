...
public class Tarea {
	...
	@JoinTable(
				...
				joinColumns = @JoinColumn(name="tarea_id"), // clave foaena de la actual tabla 
				inverseJoinColumns = @JoinColumn(name="empleado_id") // calve foreanea de la entidad relacionada
			)
